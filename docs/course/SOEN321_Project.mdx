...
1. Domain Resolution Process
    ...
    ![Domain Resolution Process](/resources/note/SOEN321/DRP.png)

2. Threat Model

    ![Threat Model](/resources/note/SOEN321/DRP_TM.png)
    ...
    ![DNS resolution paths](/resources/note/SOEN321/DNSRP.png)

...
<object data={useBaseUrl('assets/COMP 354/designpatternscard')} type="application/pdf" width="100%" height="850px">
    <embed src={useBaseUrl('assets/COMP 354/designpatternscard')} type="application/pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href={useBaseUrl('assets/COMP 354/designpatternscard')}>Download PDF</a>.</p>
    </embed>
</object>
...
![Pattern-based design in context](/assets/COMP 354/Pattern_in_context.png "Pattern-based design in context")
...
* e.g.: ![Pattern-based design in context](/assets/COMP 354/Adapter.png "Adapter")
...
* e.g.: ![Pattern-based design in context](/assets/COMP 354/Singleton.png "Singleton")
...
* e.g.: ![Pattern-based design in context](/assets/COMP 354/Strategy.png "Strategy")
...
* e.g.: ![Pattern-based design in context](/assets/COMP 354/Composite.png "Composite")

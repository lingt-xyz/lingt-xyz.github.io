...
<object data={useBaseUrl('assets/COMP 354/designpatternscard.pdf')} type="application/pdf" width="100%" height="850px">
    <embed src={useBaseUrl('assets/COMP 354/designpatternscard.pdf')} type="application/pdf">
            </embed>
</object>
...
![Pattern-based design in context](/assets/COMP354/Pattern_in_context.png "Pattern-based design in context")
...
* e.g.: ![Pattern-based design in context](/assets/COMP354/Adapter.png)
...
* e.g.: ![Pattern-based design in context](/assets/COMP354/Singleton.png "Singleton")
...
* e.g.: ![Pattern-based design in context](/assets/COMP354/Strategy.png "Strategy")
...
* e.g.: ![Pattern-based design in context](/assets/COMP354/Composite.png "Composite")

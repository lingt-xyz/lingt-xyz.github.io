...
![Encryption Model](/assets/SOEN321/Encryption_Model.png)
...
![Shift Cipher](/assets/SOEN321/Shift_Cipher.png)
...
![Vernam Cipher](/assets/SOEN321/Vernam_Cipher.png)
...
* How it works
    * Output a 64-byte block of key stream and increments block counter in each invocation
        * $k=\text{chacha{\textunderscore}stream(key, nonce, counter)}$
    * $c_i = m_i \oplus k_i$
...
![Bijection](/assets/SOEN321/Bijection.png)
![Non Bijection](/assets/SOEN321/Bijection_Non.png)
...
![SP](/assets/SOEN321/SP.png)
![SP Transposition](/assets/SOEN321/SP_T.png)
...
![Feistel Structure](/assets/SOEN321/Feistel_Structure.png)
...
![S-box](/assets/SOEN321/S_box.png)
...
* Double/Triple encryption (DES)
    ...
    * $C=E_{k_2}(E_{k_1}(P))$
    ...
    ![Double/Triple encryption](/assets/SOEN321/D_T_encryption.png)
    ...
    3. Rounds (Nr-1 times)
        ...
        4. AddRoundKey(State, $Key_R$):
            ...
            * For each round, a subkey is derived from the main key using Rijndael's key schedule
            ...
            ![AddRoundKey](/assets/SOEN321/AddRoundKey.png)
...
![Iterated Hash Functions](/assets/SOEN321/Iterated_Hash_function.png)

#### The Merkle–Damgård (MD) Construction of hash functions

![Merkle–Damgård Construction](/assets/SOEN321/MD_Scheme.png)
...
![Public Key Encryption](/assets/SOEN321/Public_Key_Encryption.png)
...
![Public Key Encryption MITM](/assets/SOEN321/Public_Key_Encryption_MITM.png)
...
![D-H Key Exchange](/assets/SOEN321/D_H_Key.png)
...
![D-H Man in the Middle](/assets/SOEN321/mitm.png)
...
![Bot nets](/assets/SOEN321/botnets.png)
...
* How to control: 
    * Centralized
    ...
    ![Bot center](/assets/SOEN321/bot_center.png)

    * P2P
        * robust againt disruption
        * Inefficient
        * unreliable from attackers' viewpoint
    ![Bot P2P](/assets/SOEN321/bot_p2p.png)
...
![Mirai](/assets/SOEN321/Mirai.png)
